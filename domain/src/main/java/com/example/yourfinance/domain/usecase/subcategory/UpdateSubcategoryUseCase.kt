...
class UpdateSubcategoryUseCase @Inject constructor(private val categoryRepository: CategoryRepository) {
    suspend operator fun invoke(subcategory: com.example.yourfinance.domain.model.entity.category.Subcategory) {
