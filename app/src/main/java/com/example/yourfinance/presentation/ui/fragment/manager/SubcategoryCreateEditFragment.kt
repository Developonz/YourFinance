...
class SubcategoryCreateEditFragment : Fragment() {
    ...
    private fun populateUI(subcategory: Subcategory) {
                ...
                return when (menuItem.itemId) {
                    R.id.action_save -> {
                        ...
                        if (isEditMode) {
                            ...
                            viewModel.createSubcategory(Subcategory(title = name, categoryType = args.categoryType, parentId = args.parentId))
                        }
                        findNavController().popBackStack()
                        true
                    }
